...
module.exports = {
    ...
    SESSION: process.env.YUI_SESSION === undefined ? '' : process.env.YUI_SESSION,
    ...
    Z_HIMW_AI: process.env.Z_HIMW_AI === undefined ? 'false' : process.env.Z_HIMW_AI,
    ...
    PLKIMG: process.env.LIST_IMG === undefined ? 'https://i.imgur.com/tKPOmkX.jpeg' : process.env.LIST_IMG,
    WEL_GIF: process.env.WEL_GIF === undefined ? 'https://i.imgur.com/nErXUGj.mp4' : process.env.WEL_GIF,
    GIF_BYE: process.env.GIF_BYE === undefined ? 'https://i.imgur.com/Z1jCYGN.mp4' : process.env.GIF_BYE,
    BOTPLK: process.env.BOT_NAME === undefined ? '(NAME)' : process.env.BOT_NAME,
    ...
    OA_NAME: process.env.DEPLOYER === undefined ? 'YourName' : process.env.DEPLOYER,    
