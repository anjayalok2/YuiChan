...
if (Config.WORKTYPE == 'private') {
    ...
    Nexus.addCommand({pattern: 'alive', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
    ...
    Nexus.addCommand({pattern: 'sysd', fromMe: true, desc: Lang.SYSD_DESC}, (async (message, match) => {
   ...
   Nexus.addCommand({pattern: 'alive', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
...
r_text[31] = "If you lose dont worry becoz if you can understand that lose and work hard , you can have next 10 success.\n  -NᴇᷠxᷱꪊSᗒsɪʀ⁩⚠︎";
var i = Math.floor(32*Math.random())
    ...
    if (Config.ALIVEMSG.includes('{pp}')) {
        ...
        a_plk[0] = "https://i.imgur.com/z9U3XtG.jpeg";
        a_plk[1] = "https://i.imgur.com/xhfdItb.jpeg";
        a_plk[2] = "https://i.imgur.com/VohRHGI.jpeg";
        a_plk[3] = "https://i.imgur.com/2G3azlX.jpeg";
        a_plk[4] = "https://i.imgur.com/tu3aLe5.jpeg";
        a_plk[5] = "https://i.imgur.com/K4yW4U2.jpeg";
        a_plk[6] = "https://i.imgur.com/nfXFb1F.jpeg";
        a_plk[7] = "https://i.imgur.com/MtrlxZB.jpeg";
        a_plk[8] = "https://i.imgur.com/4vmyU8g.jpeg";
        a_plk[9] = "https://i.imgur.com/Ciuew71.png";
        a_plk[10] = "https://i.imgur.com/59ncKvV.jpeg";
...
//codded by afnanplk
    ...
    Nexus.addCommand({pattern: 'sysd', fromMe: false, desc: Lang.SYSD_DESC}, (async (message, match) => {
    ...
    Nexus.addCommand({pattern: 'psysd', fromMe: true, desc: Lang.SYSD_DESC, dontAddCommandList: true }, (async (message, match) => {
